...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { email: @administrator.email, image: @administrator.image, name: @administrator.name, password: @administrator.password, sex: @administrator.sex } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { email: @administrator.email, image: @administrator.image, name: @administrator.name, password: @administrator.password, sex: @administrator.sex } }
