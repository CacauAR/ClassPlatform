...
class ClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class" do
    assert_difference('Classe.count') do
      post classes_url, params: { class: { course_id: @class.course_id, professor_id: @class.professor_id } }
    end
  ...
  test "should update class" do
    patch class_url(@class), params: { class: { course_id: @class.course_id, professor_id: @class.professor_id } }
