...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { email: @professor.email, image: @professor.image, name: @professor.name, password: @professor.password, registry: @professor.registry, sex: @professor.sex } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { email: @professor.email, image: @professor.image, name: @professor.name, password: @professor.password, registry: @professor.registry, sex: @professor.sex } }
